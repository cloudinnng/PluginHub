...
namespace PluginHub.Runtime
{
    ...
    public class EditorStyleCameraMovement : MonoBehaviour
    {
        ...
        [Tooltip("Exponential boost factor on translation, controllable by mouse wheel.相机运动速度")]
        public float boost = 3.5f;

        [Tooltip("Time it takes to interpolate camera position 99% of the way to the target.该值越大，相机运动到最后会滑动一下"),
         Range(0.001f, 1f)]
