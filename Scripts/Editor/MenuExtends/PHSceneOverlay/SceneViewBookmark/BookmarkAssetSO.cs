...
namespace PluginHub.Editor
{
    ...
    public class BookmarkAssetSO : ScriptableObject
    {
        ...
        public SceneBookmarkGroup GetSceneBookmarkGroup(string scenePath)
        {
            SceneBookmarkGroup sceneBookmarkGroup = bookmarkGroups.Find(x => x.scenePath == scenePath);
            if(sceneBookmarkGroup == null)
            {
                sceneBookmarkGroup = new SceneBookmarkGroup() { scenePath = scenePath };
                bookmarkGroups.Add(sceneBookmarkGroup);
            }
            return sceneBookmarkGroup;
        }
